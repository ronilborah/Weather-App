export const WeatherBackground = ({ weather }: { weather: string }) => {
  const getBackgroundElements = () => {
    switch (weather) {
      ...
      case "rainy":
        return (
          <div className="absolute inset-0 bg-gradient-to-br from-gray-700 via-blue-800 to-gray-900">
            {/* Rain drops */}
      ...
      default:
        return <div className="absolute inset-0 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600"></div>
    }
  }
